  ...
  return (
    <div className="flex items-center justify-between mt-5 w-full px-12 py-2 ">
      ...
      <div className="flex items-center justify-center font-semibold">
        <div className={`mr-8 border px-[12px] py-2 rounded-[100%]  cursor-pointer
          ${tempFormat == "celsius" ? "bg-[black] text-white" : "bg-white text-[#2d2d2d]"} text-black `}
          onClick={() => handleTempFormat("celsius")}
        > °C </div>
        <div className={`mr-8 border  px-[12px] py-2 rounded-[100%] cursor-pointer 
          ${tempFormat == "fahrenheit" ? "bg-black text-white" : "bg-white text-[#2d2d2d]" } text-black `}
